(function () {
	...
	angular.module('eduAction')
		.controller('formPersonal', function ($scope, $rootScope, $state, $transitions, $http, toaster, $filter) {
			...
			if ($rootScope.currentUser.info != null) {
				$scope.personal = $rootScope.currentUser.info
				$scope.personal.passport_issued_date = new Date($scope.personal.passport_issued_date)
				$scope.personal.passport_expiration_date = new Date($scope.personal.passport_expiration_date);
				$scope.languages = [];

				$rootScope.currentUser.languages.forEach(function (p) {
					$scope.languages.push(p.language);
				})
				setTimeout(function () {
					$scope.languages.forEach(function (p) {
						$scope.spokenLanguages.forEach(function (d) {
							if (p.id == d.id) {
